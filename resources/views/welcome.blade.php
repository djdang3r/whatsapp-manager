    ...
    <div class="landing-wrapper">
        ...
        <div class="navbar navbar-expand-lg sticky-top landing-nav_main px-3 position-fixed w-100">
            <div class="container-fluid">
                ...
                <div class="navbar-collapse" id="landing_nav">
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a href="https://forms.gle/q7wFQQRtS2fLDZWbA" class="nav-link" target="_blank">Hire Us</a>
                        </li>
                    </ul>

                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="btn btn-primary mr-3">Log In</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary mr-3">Log In</a>
                        ...
                        <div class="landing-img">
                            <div class="img-box">
                                ...
                                <div class="rotated-circle-text">
                                    <img src="../assets/images/landing/circle-text.png" class="w-150 h-150 img-rotated" alt="img">
                                    <img src="../assets/images/logo/3.png" alt="img" class="bg-light-primary p-4 b-r-50 b-1-primary">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="language-box">
                <div class="language-box-item">
                    <a href="./index.html" target="_blank" class="info-box bg-info h-60 w-60 d-flex-center b-r-50"
                       data-bs-toggle="tooltip" data-bs-custom-class="custom-dark" data-bs-html="true"
                       data-bs-original-title="Bootstrap">
                        <i class="devicon-bootstrap-plain f-s-28 align-text-bottom"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="https://phpstack-426242-2145512.cloudwaysapps.com/RaAdmin-PHP/template/index.php" class="danger-box bg-danger h-60 w-60 d-flex-center b-r-50" data-bs-toggle="tooltip"
                       target="_blank" data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="PHP">
                        <i class="devicon-php-plain f-s-30 align-middle"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="./index.html" class="primary-box bg-primary h-60 w-60 d-flex-center b-r-50" target="_blank" data-bs-toggle="tooltip"
                       data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="Laravel">
                        <i class="devicon-laravel-plain f-s-28 align-middle"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="https://www.figma.com/design/BwsML2vqoiWf764OVrymN3/RA-ADMIN?node-id=0-1&node-type=canvas&t=JJ14dHmrXRZ33NQ1-0" target="_blank" class="warning-box bg-warning h-60 w-60 d-flex-center b-r-50" data-bs-toggle="tooltip"
                       data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="Figma">
                        <i class="devicon-figma-plain f-s-26 align-text-bottom text-white"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="./index.html" target="_blank" class="success-box bg-success h-60 w-60 d-flex-center b-r-50" data-bs-toggle="tooltip"
                       data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="Codeigniter">
                        <img src="../assets/images/document/codeigniter.png" alt="avtar" class="w-25 h-25">
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="./index.html" target="_blank" class="dark-box bg-dark h-60 w-60 d-flex-center b-r-50" data-bs-toggle="tooltip"
                       data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="Symfony">
                        <i class="devicon-symfony-plain f-s-26"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="https://phpstack-426242-2145512.cloudwaysapps.com/RaAdmin-PHP/template/index.php" class="danger-box bg-danger h-60 w-60 d-flex-center b-r-50" data-bs-toggle="tooltip"
                       target="_blank" data-bs-custom-class="custom-dark" data-bs-html="true" data-bs-original-title="CakePHP">
                        <i class="devicon-cakephp-plain f-s-30 align-middle"></i>
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <ul class="nav nav-tabs app-tabs-dark" id="v-bg" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="apps-tab" data-bs-toggle="tab"
                                        ...
                                        type="button" role="tab" aria-controls="apps-tab-pane" aria-selected="false"
                                        tabindex="-1">
                                    <i class="ti ti-server pe-2 ps-1"></i> Apps
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ui-tab" data-bs-toggle="tab" data-bs-target="#ui-tab-pane"
                                        type="button"
                                        role="tab" aria-controls="ui-tab-pane" aria-selected="false" tabindex="-1">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="advance-ui-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="advance-ui-tab-pane"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="icons-tab" data-bs-toggle="tab"
                                        ...
                                        type="button" role="tab" aria-controls="icons-tab-pane" aria-selected="false"
                                        tabindex="-1">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="forms-tab" data-bs-toggle="tab"
                                        ...
                                        type="button" role="tab" aria-controls="forms-tab-pane" aria-selected="false"
                                        tabindex="-1">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ready-touse-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="ready-touse-tab-pane"
                                        aria-selected="false" tabindex="-1">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                                ...
                                                <div class="demo-box">
                                                    ...
                                                    <a href="index.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="project_dashboard.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="crypto_dashboard.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <img src="../assets/images/landing/education-dashboard.jpg" alt="demo-img"
                                                 class="img-fluid b-r-8">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Education</h6>
                                                <a href="education.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="calendar.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                   <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="profile.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="team.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="chat.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="email.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                                 <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Ecommerce</h6>
                                                <a href="product.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="to_do.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="file_manager.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="blog.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                  <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="alert.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="badges.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="buttons.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="dropdown.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="avtar.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="accordions.html" target="_blank" role="button" class="btn btn-warning  icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="progress.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="notifications.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="modals.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="sweetalert.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="animation.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="video_embed.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="tour.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="slick.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="ratings.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="count_down.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="fontawesome.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="flag_icons.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="animated_icon.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="weather_icon.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="basic_table.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="data_table.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="list_table.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="advance_table.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="base_inputs.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="form_validation.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="checkbox_radio.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="input_masks.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="floating_labels.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="select.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="range_slider.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="clipboard.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="file_upload.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="dual_list_boxes.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="default_forms.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                        ...
                        <div class="tab-pane fade" id="ready-touse-tab-pane" role="tabpanel" tabindex="0">
                            <div class="row">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="form_wizards.html" target="_blank" role="button" class="btn btn-secondary icon-btn b-r-22">
                                                   <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="form_wizard_1.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="form_wizard_2.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="ready_to_use_form.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                    <i
                                                            class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img src="../assets/images/landing/ready-to-use-table.jpg" alt="demo-img"
                                                 class="img-fluid b-r-8">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Ready To Use table</h6>
                                                <a href="ready_to_use_table.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="sign_in.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="sign_in_1.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="sign_up.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="sign_up_1.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="pwd_create.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="pwd_reset.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="lock_screen.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="two_step_verification.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="error_400.html" target="_blank" role="button" class="btn btn-danger icon-btn b-r-22">
                                                   <i
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="error_403.html" target="_blank" role="button" class="btn btn-success icon-btn b-r-22">
                                                    <i
                                                            class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="error_404.html" target="_blank" role="button" class="btn btn-primary icon-btn b-r-22">
                                                    <i
                                                            class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="error_500.html" target="_blank" role="button" class="btn btn-warning icon-btn b-r-22">
                                                    <i
                                                            class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a href="error_503.html" target="_blank" role="button" class="btn btn-info icon-btn b-r-22">
                                                   <i
                                                            class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                                </a>
                                            </div>
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <div class="landing-title text-md-center">
                        ...
                        <p class="text-light">After reading the instructions, I had a few inquired queries about the process
                        ...
                        <div class="col-lg-12 col-sm-6 mb-3">
                            <div class="card-boxs">
                                ...
                                <div class="box-content">
                                    ...
                                    <a role="button" target="_blank" class="btn btn-primary" href="document.html">Check
                                        Document</a>
                                </div>
                        ...
                        <div class="slider-container">
                            <div class="slider-container-box">
                                <div class="slider-slideUp">
                                    <img src="../assets/images/landing/landing-bg.png" class="img-fluid" alt="card-img">
                                </div>
                                <div class="slider-slideUp">
                                    <img src="../assets/images/landing/landing-bg.png" class="img-fluid" alt="card-img">
                                </div>
                            ...
                            <div class="slider-container-box slider-left">
                                <div class="slider-slideDown">
                                    <img src="../assets/images/landing/landing-bg-1.png" class="img-fluid"
                                         alt="card-img">
                                </div>
                                <div class="slider-slideDown">
                                    <img src="../assets/images/landing/landing-bg-1.png" class="img-fluid"
                            ...
                            <div class="slider-container-box">
                                <div class="slider-slideUp">
                                    <img src="../assets/images/landing/landing-bg-2.png" class="img-fluid"
                                         alt="card-img">
                                </div>
                                <div class="slider-slideUp">
                                    <img src="../assets/images/landing/landing-bg-2.png" class="img-fluid"
    ...
    <section class="element-section">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <div class="landing-title text-md-center">
                        <h2><span class="highlight-title">Elements</span> of ra-admin</h2>
                        ...
                        <div>
                            ...
                            <div class="element-content">
                                ...
                                <p>Apply Custom button styles to forms, dialogs, and various elements, featuring support
                                    for multiple
                                    sizes and states.</p>
                                <a role="button" href="./buttons.html" target="_blank" class="link-btn link-primary mt-3 ">View Buttons
                                    <i
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create stylish cards with Admin Element for organized content presentation and a
                                    sleek user
                                    interface.</p>
                                <a role="button" href="./cards.html" target="_blank" class="link-btn link-primary mt-3">View Cards <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="element-content">
                                ...
                                <p>Easily design lists with Admin Element intuitive elements for structured content
                                    display, enhancing
                                    user experience.</p>
                                <a role="button" href="./list.html" target="_blank" class="link-btn link-primary mt-3">View List <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create alerts using Admin Elements intuitive elements to effectively communicate
                                    messages.</p>
                                <a role="button" href="./alert.html" target="_blank" class="link-btn link-primary mt-3">View Alerts <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create collapsible accordion in Admin for organized content presentation, optimizing
                                    user
                                    interaction.</p>
                                <a role="button" href="./accordions.html" target="_blank" class="link-btn link-primary mt-3">View
                                    Accordions <i
                                            class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create dropdown using Admin Elements for enhanced user interaction and intuitive
                                    navigation.</p>
                                <a role="button" href="./dropdown.html" target="_blank" class="link-btn link-primary mt-3">View Dropdown
                                    <i
                                            class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create dividers effortlessly with Admin Elements utilities, enhancing content
                                    organization. </p>
                                <a role="button" href="./divider.html" target="_blank" class="link-btn link-primary mt-3">View Dividers
                                    <i
                                            class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Utilize Progress components for visually appealing representation of task completion
                                    and data
                                    loading. </p>
                                <a role="button" href="./progress.html" target="_blank" class="link-btn link-primary mt-3">View Progress
                                    <i
                                            class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Employ Admin notification Elements for streamlined user alerts, enhancing
                                    ...
                                    experience. </p>
                                <a role="button" href="./notifications.html" target="_blank" class="link-btn link-primary mt-3">View
                                    Notifications <i
                                            class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="slider-container">
                        <div class="slider-container-box">
                            <div class="slider-slideLeft">
                                <img src="../assets/images/landing/dark-layout.png" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="slider-container-box slider-left">
                            <div class="slider-slideRight">
                                <img src="../assets/images/landing/dark-layout-1.png" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 text-center">
                    <button type="button" class="btn btn-lg btn-primary mt-5" id="darkDemoBtn">Check Now<i
                    ...
                    <div class="card  sidebar-option-card">
                        <div class="card-body p-0">
                            <div class="">
                                ...
                                <div class="">
                                    <h2 class="text-white f-w-600">Customize your <br> <span class="text-dark">sidebar</span> with ease</h2>
                                </div>
                                <div class="text-end">
                                    <img src="../assets/images/landing/layout.png" class="img-fluid mt-3" alt="layout-img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card equal-card color-hint-card">
                        <div class="card-body">
                            ...
                            <div>
                                <img src="../assets/images/landing/color-hint.gif" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card speed-performance-card">
                        <div class="card-body text-center">
                            ...
                            <div class="mt-5">
                                <img src="../assets/images/landing/speed-performance.png" class="img-fluid" alt="">
                            </div>

                             <div class="performance-content ">
                                <div class="text-end">
                                    <img src="../assets/images/landing/arrow-shape.png" class="arrow-shape" alt="img">
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4 position-relative">
                                    ...
                                    <svg width="98" height="132" viewBox="0 0 98 132" fill=""
                                         xmlns="http://www.w3.org/2000/svg"
                                         class="text-brand absolute hidden md:block -left-12 xl:-left-24 -bottom-32 xl:-bottom-44 transition ease-in-out transform-gpu">
                                ...
                                <div class="col-sm-8 z-1">
                                    <img src="../assets/images/landing/layout-option.png" class="img-fluid mt-4"
                                         alt="layout-img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-5 col-xl-6">
                                    <div>
                                        <img src="../assets/images/landing/wallet.png" class="w-120" alt="img">
                                        <div>
                                            <p class="badge bg-primary f-s-16 mt-3">Basic Plans</p>
                                            <h1 class="text-dark f-w-700 mt-3">$14.00</h1>
                                            <p class="text-secondary  txt-ellipsis-3 f-w-500 f-s-16"> Essential features at the best
                                ...
                                <div class="col-md-7 col-xl-6 ">
                                    <div class="pricing-details">
                                        <div class="price-title">
                                            <h3 class="text-dark f-w-600 txt-ellipsis-1">Basic Plans List</h3>
                                            ...
                                            <div class="text-center price-btn">
                                                <a href="https://themeforest.net/user/la-themes" target="_blank" class="btn btn-lg btn-dark">Buy
                                                    Plans</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="pricing-details">
                                <div class="price-title">
                                    ...
                                    <h2>$499.00</h2>
                                    <ul class="pricing-list-menu">
                                        <li class="pricing-listitem text-dark"><i
                                                class="ph-bold  ph-check text-success me-2"></i>6 Month support
                                        </li>
                                        <li class="pricing-listitem text-dark"><i
                                    ...
                                    <div class="text-center price-btn">
                                        <a href="https://themeforest.net/user/la-themes" target="_blank" class="btn btn-lg btn-primary">Buy
                                            Plans</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-content text-center">
                        ...
                        <p class="txt-ellipsis-3">Purchase The Ra-admin & Craft Your Site Super Faster And powerful. Discover the Ra-admin
                            Admin Theme.
                            If you enjoy our template, please take a moment to rate us</p>
                        <div class="footer-btn">
                            <a href="https://themeforest.net/user/la-themes" class="btn btn-primary btn-lg"
